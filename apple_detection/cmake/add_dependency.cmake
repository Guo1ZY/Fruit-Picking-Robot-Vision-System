...
macro(add_zed target)
    ...
    target_include_directories(${target} PUBLIC ${ZED_INCLUDE_DIRS})

    target_link_directories(${target} PUBLIC ${ZED_LIBRARY_DIR})

    target_link_libraries(${target} PUBLIC ${ZED_LIBRARIES})
