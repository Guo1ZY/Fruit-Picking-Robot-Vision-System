...
public:
     ...
     */
    Yolov8(const std::string modelPath, const std::string classesPath, const bool &runWithCuda = false, const cv::Size &modelInputShape = {256, 256}, const float &modelConfThreshold = 0.5, const float &modelIouThreshold = 0.5);
